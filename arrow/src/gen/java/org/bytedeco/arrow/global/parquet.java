...
@Namespace("parquet::internal") public static native @ByVal MinMax FindMinMax(@Const ShortPointer levels, @Cast("int64_t") long num_levels);
@Namespace("parquet::internal") public static native @ByVal MinMax FindMinMax(@Const ShortBuffer levels, @Cast("int64_t") long num_levels);
@Namespace("parquet::internal") public static native @ByVal MinMax FindMinMax(@Const short[] levels, @Cast("int64_t") long num_levels);
